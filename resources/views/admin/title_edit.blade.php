...
@section('content')
    <div class="row">
        {{Form::model($thisTitleInfo,array('route' =>array( 'title_edit','id'=>$thisTitleInfo->id),'method' => 'put','files' => false,))}}
        <div class="col-md-12">
            <!-- The time line -->
            <ul class="timeline">
                <!-- timeline time label -->
                ...
                <li>
                    ...
                    <div class="timeline-item">
                        <span class="time"><i class="fa fa-bell-o"></i> </span>

                        <h3 class="timeline-header"><a href="#">数据内容导入修改|</a> 请按需导入</h3>

                        <div class="timeline-body">
                            <div class="row">

                                <div class="form-group col-md-6">
                                    {{Form::label('typeid',  '标题分类', array('class' => 'control-label col-md-2 col-sm-3 col-xs-12','style'=>'padding-top:5px;'))}}
                                    <div class="col-md-8 input-group col-sm-9 col-xs-12">
                                        <div class="input-group-addon">
                                            <i class="fa fa-file-text-o" style="width:10px;"></i>
                                        </div>
                                        {{Form::select('typeid', $titleTypes, null,array('class'=>'form-control pull-right select2'))}}
                                    </div>
                                </div>
                                <div class="form-group col-md-6">
                                    {{Form::label('title',  '标题内容', array('class' => 'control-label col-md-2 col-sm-3 col-xs-12','style'=>'padding-top:5px;'))}}
                                    <div class="col-md-8 input-group col-sm-9 col-xs-12">
                                        <div class="input-group-addon">
                                            <i class="fa fa-file-text-o" style="width:10px;"></i>
                                        </div>
                                        {{Form::text('title', null,array('class'=>'form-control','id'=>'title','placeholder'=>'标题'))}}
                                    </div>
                                </div>
                            </div>
                        </div>
