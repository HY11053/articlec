...
@section('content')
    <div class="row">
        {{Form::open(array('route' => 'conditionadd'))}}
        <div class="col-md-12">
            <!-- The time line -->
            <ul class="timeline">
                <!-- timeline time label -->
                        ...
                        <div class="timeline-body">
                            <div class="row">
                                <div class="form-group col-md-12">
                                    {{Form::textarea('body',null, array('class' => 'form-control col-md-10','id'=>'content','rows'=>27,'placeholder'=>'根据说明按需导入'))}}
                                </div>
                            </div>
                        </div>
