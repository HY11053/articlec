...
@section('header_position')
    <section class="content-header">
        <h1>Paymeng Lists<small>Paymeng Lists</small></h1>
        <ol class="breadcrumb"><li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li><li class="active">Paymeng Lists</li></ol>
    </section>
@stop
@section('content')
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">加盟费用列表管理 文档总计{{$articles->total()}}</h3>
                    <div class="box-tools">
                        <div class="pull-right" style="display:inline-block; width: 220px">
                            <a href="{{action('PaymentController@Paymentadd')}}" style="color: #ffffff ; display: inline-block; padding-left: 3px;"><button  class="btn btn-sm btn-default bg-blue"><i class="fa  fa-pencil-square" style="padding-right: 3px;"></i>添加加盟费用</button></a>
                        </div>
                        ...
                        <table class="table table-hover">
                            ...
                            @foreach($articles as $article)
                                <tr>
                                    ...
                                    <td class="astyle">
                                        <span class="label label-warning"><a href="/payment/edit/{{$article->id}}">编辑</a></span>
                                    </td>
                                </tr>
                            @endforeach
                        </table>
