...
@section('content')
    <div class="row">
        {{Form::open(array('route' => 'fmimport_titles'))}}
        <div class="col-md-12">
            <!-- The time line -->
            <ul class="timeline">
                <!-- timeline time label -->
                ...
                <li>
                    ...
                    <div class="timeline-item">
                        <span class="time"><i class="fa fa-bell-o"></i>  一行一组 最大不超过500行</span>
                        ...
                        <div class="timeline-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-12">
                                    {{Form::textarea('content',null, array('class' => 'form-control col-md-10','id'=>'content','rows'=>27,'placeholder'=>'不填写将自动提取首段'))}}
                                </div>
                            </div>
                        </div>
