                        ...
                        <div class="timeline-item">
                            ...
                            <div class="timeline-body">
                                ...
                                @if($thiwebinfo->webname=='51xxsp' || $thiwebinfo->webname=='xiuxianshipin' ||  $thiwebinfo->webname=='jjedu')
                                    ...
                                    <div class="form-group col-md-12">
                                        {{Form::label('brandpsp', '品牌特色', array('class' => 'control-label col-md-1'))}}
                                        <div class="input-group col-md-4">
                                            <div class="input-group-addon"><i class="fa fa-meh-o" style="width:10px;"></i></div>
                                            {{Form::text('brandpsp',null, array('class' => 'form-control  pull-right','id'=>'brandpsp','placeholder'=>'品牌特色','required'=>'required'))}}
                                        </div>
                                    </div>
                                @endif
                                <div class="form-group col-md-12">
